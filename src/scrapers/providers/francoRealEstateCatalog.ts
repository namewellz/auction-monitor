...
function mapLot(lot: ApiLot, detail: { images: string[]; documents: NonNullable<LotData['documents']>; description: string }): LotData {
  ...
  return {
    ...
    ...(realtime.ValorMinimoLancePrimeiraPraca ? { firstRoundMinimumValue: realtime.ValorMinimoLancePrimeiraPraca } : {}),
    ...(realtime.ValorMinimoLanceSegundaPraca ? { secondRoundMinimumValue: realtime.ValorMinimoLanceSegundaPraca } : {}),
    ...(realtime.ValorMinimoLanceTerceiraPraca ? { thirdRoundMinimumValue: realtime.ValorMinimoLanceTerceiraPraca } : {}),
