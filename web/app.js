...
function siteLabel(site) { return ({ leilo: 'Leilo', vipleiloes: 'VIP Leilões', superbid: 'Superbid', francoleiloes: 'Franco Leilões', alessandroteixeira: 'Alessandro Teixeira Leilões', alvaroleiloes: 'Álvaro Leilões', brunoleiloes: 'Bruno Leilões', calilleiloes: 'Calil Leilões', capitalvalorleiloes: 'Capital Valor Leilões', d1lance: 'D1 Lance', carloferrarileiloes: 'Carlo Ferrari Leilões', dasilvaleiloes: 'Da Silva Leilões', cidafixerleiloes: 'Cida Fixer Leilões', doleiloes: 'Dó Leilões', trileiloes: 'TRI Leilões', thaisteixeiraleiloes: 'Thaís Teixeira Leilões', valeroleiloes: 'Valero Leilões', rigolonleiloes: 'Rigolon Leilões', leiloesjudiciaisbahia: 'Leilões Judiciais Bahia', fabioleiloes: 'Fábio Leilões', galvanileiloes: 'Galvani Leilões', joserodovalholeiloes: 'José Rodovalho Leilões', rosioliveiraleiloes: 'Rosi Oliveira Leilões', fidelisleiloes: 'Fidelis Leilões' })[site] || site || ''; }
