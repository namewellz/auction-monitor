...
function siteLabel(site) { return ({ leilo:'Leilo',vipleiloes:'VIP Leilões',superbid:'Superbid',francoleiloes:'Franco Leilões',alessandroteixeira:'Alessandro Teixeira',alvaroleiloes:'Álvaro Leilões',brunoleiloes:'Bruno Leilões',calilleiloes:'Calil Leilões',capitalvalorleiloes:'Capital Valor',d1lance:'D1 Lance',carloferrarileiloes:'Carlo Ferrari',dasilvaleiloes:'Da Silva',cidafixerleiloes:'Cida Fixer',doleiloes:'Dó Leilões',trileiloes:'TRI Leilões',thaisteixeiraleiloes:'Thaís Teixeira',valeroleiloes:'Valero',rigolonleiloes:'Rigolon',leiloesjudiciaisbahia:'Leilões Judiciais Bahia',fabioleiloes:'Fábio Leilões',galvanileiloes:'Galvani',joserodovalholeiloes:'José Rodovalho',rosioliveiraleiloes:'Rosi Oliveira',fidelisleiloes:'Fidelis' })[site] || site || ''; }
